...
import { match, UnMatched, Matched, UnMatchedPatternError } from 'potoo-lib/fpl/control/Match';
...
describe('UnMatched', function() {
    ...
    it('should match functions (classes)', function() {
        ...
        must(new UnMatched(new Date()).caseOf(RegExp, id)).be.instanceOf(UnMatched);
