...
export class Case<T> {
    ...
    constructor(
        pattern: object,
        f: (value: { [P in keyof T]: Message }) => void
    );
...
export function caseOf(
    pattern: NumberConstructor,
    handler: (value: number) => void
): Case<number>;
export function caseOf(
    pattern: BooleanConstructor,
...
export function caseOf<T>(
    pattern: object,
    handler: (value: { [P in keyof T]: Message }) => void
): Case<object>;
export function caseOf(
    pattern: string,
    handler: (value: string) => void
...
export function caseOf<T>(pattern: any, handler: Handler<T>): Case<any>;
