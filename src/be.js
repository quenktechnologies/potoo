import { left, right, Right } from './monad';
...
export const or = (l, r) => {
    ...
    if (typeof l !== 'function')
        throw new TypeError(`or(): ${expected('a function for left value')}`, l);

    if (typeof r !== 'function')
        throw new TypeError(`or(): ${expected('a function for right value')}`, l);
