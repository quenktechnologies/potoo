...
var Match_1 = require("afpl/lib/control/Match");
var Free_1 = require("afpl/lib/monad/Free");
var Maybe_1 = require("afpl/lib/monad/Maybe");
var IO_1 = require("afpl/lib/monad/IO");
var util_1 = require("afpl/lib/util");
var SharedBuffer_1 = require("afpl/lib/async/SharedBuffer");
/**
 ...
 * ActorWT
 */
var ActorWT = (function (_super) {
    __extends(ActorWT, _super);
    function ActorWT(askee, actor, next) {
        var _this = _super.call(this, 'wt', askee, exports.noop) || this;
        _this.askee = askee;
        _this.actor = actor;
        _this.next = next;
        return _this;
...
var Axiom = (function () {
    ...
    Axiom.prototype.map = function (f) {
        return Match_1.match(this)
            ...
            .caseOf(Ask, function (_a) {
            var askee = _a.askee, message = _a.message, next = _a.next;
            return new Ask(askee, message, util_1.compose(f, next));
        })
...
var Ask = (function (_super) {
    ...
    function Ask(askee, message, next) {
 ...
 * CPS
 */
var CPS = (function (_super) {
    __extends(CPS, _super);
    function CPS(cont) {
        var _this = _super.call(this) || this;
        _this.cont = cont;
        return _this;
...
exports.evalAxiomChain = function (ch, a, s) {
    return Match_1.match(ch)
        ...
        return Match_1.match(f)
            ...
            .caseOf(Ask, function (f) { return s.log(f).chain(function () { return exports.evalAsk(f, a, s); }); })
            ...
            .caseOf(CPS, function (f) { return s.log(f).chain(function () { return exports.evalCPS(f, a, s); }); })
 ...
 * evalTell
 */
exports.evalTell = function (op, a, s) {
    var to = op.to, message = op.message, next = op.next;
    return exports.pathToActor(to, a, s)
 ...
 * evalAsk
 */
exports.evalAsk = function (op, a, s) {
    var askee = op.askee, message = op.message, next = op.next;
    return exports.putActor(a.path, new ActorWT(askee, a, next), s)
        .chain(function (s) { return exports.pathToActor(askee, a, s); })
        .chain(function (t) { return exports.feedActor(message, t, a, s); })
        .map(function () { return s; });
};
/**
 * evalEffect
 */
exports.evalEffect = function (eff, a, s) {
    var runnable = eff.runnable, next = eff.next;
 ...
 * evalCPS
 */
exports.evalCPS = function (_a, a, s) {
    var cont = _a.cont;
    return IO_1.safeIO(function () { return cont(function (chain) { return exports.runAxiomChain(chain, a, s); }); }).map(function () { return s; });
};
/**
* raiseDup
*/
 ...
 */
exports.pathToActor = function (p, a, s) {
    return p === '.' ?
        IO_1.wrapIO(a) : exports.getActorMaybe(p, s)
        .map(function (mb) { return mb.orJust(function () { return s.actors['?']; }).get(); });
};
/**
 ...
 */
exports.feedActor = function (m, to, a, s) { return Match_1.match(to)
    .caseOf(ActorDOA, function (to) { return exports.feedActorDOA(m, to, a, s); })
    .caseOf(ActorL, function (to) { return exports.feedActorL(m, to, a, s); })
    .caseOf(ActorWT, function (to) { return exports.feedActorWT(m, to, a, s); })
    .end(); };
/**
 ...
 * @param {ActorDOA} a
 */
exports.feedActorDOA = function (m, to, a, s) {
    return s.log(new DroppedMessage(m, to, a.path)).mapIn(a);
};
/**
 * feedActorL
 */
exports.feedActorL = function (m, a, _from, s) {
    return Match_1.match(a.behaviour)
 ...
 * feedActorWT
 */
exports.feedActorWT = function (m, a, from, s) {
    var askee = a.askee, actor = a.actor, next = a.next;
    return (askee === from.path) ?
        exports.putActor(actor.path, actor, s)
            .chain(function (s) { return exports.delayIO(function () { return exports.evalAxiomChain(next(m), actor, s); }); }) :
        exports.storeAuditedMessage(m, actor, s);
};
/**
...
exports.ask = function (askee, message) {
    return Free_1.liftF(new Ask(askee, message));
};
/**
 ...
 *
 */
exports.cps = function (f) { return Free_1.liftF(new CPS(f)); };
/**
