 ...
 */
var ActorConf = (function () {
    function ActorConf(id) {
        this.id = id;
    }
    return ActorConf;
}());
exports.ActorConf = ActorConf;
;
/**
 ...
 */
var LocalConf = (function (_super) {
    __extends(LocalConf, _super);
    function LocalConf(id, actorFn) {
     ...
     */
    LocalConf.from = function (id, fn) {
        return new LocalConf(id, fn);
    };
    LocalConf.prototype.create = function (path, s) {
        return new LocalContext(path, this.actorFn, s);
    };
    return LocalConf;
}(ActorConf));
exports.LocalConf = LocalConf;
/**
