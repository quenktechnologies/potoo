...
var Axiom = (function () {
    ...
    Axiom.prototype.map = function (f) {
        return Match_1.match(this)
            ...
            var callable = _a.callable, next = _a.next;
            return new Effect(callable, util_1.compose(f, next));
        })
...
var Effect = (function (_super) {
    ...
    function Effect(callable, next) {
        if (next === void 0) { next = util_1.identity; }
        var _this = _super.call(this, next) || this;
        _this.callable = callable;
        _this.next = next;
        return _this;
    }
    return Effect;
...
exports.evalTask = function (_a, a, s) {
    ...
    return IO_1.safeIO(function () {
        forkable.fork(function (e) { return exports.evalAxiomChain(exports.raise(e), a, s).run(); }, function (m) { return exports.evalAxiomChain(exports.tell(to === '.' ? a.path : to, m), a, s).run(); });
        return s;
    }).chain(function () { return exports.evalAxiomChain(next, a, s); });
};
/**
...
exports.evalTell = function (_a, a, s) {
    var to = _a.to, message = _a.message, next = _a.next;
    return exports.pathToActor(to, s)
...
exports.evalEffect = function (_a, a, s) {
    var callable = _a.callable, next = _a.next;
    return IO_1.safeIO(callable).chain(function (r) { return exports.evalAxiomChain(next(r), a, s); });
};
/**
 * evalReceive
 */
 ...
 */
exports.effect = function (f) { return Free_1.liftF(new Effect(f)); };
/**
