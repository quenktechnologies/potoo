...
var Process = /** @class */ (function () {
    ...
    Process.prototype.start = function (addr) {
        ...
        p.on('error', function (e) { return _this.system.getPlatform().raise(_this, e); });
        ...
        p.on('exit', function () {
            ...
            _this.system.getPlatform().kill(_this, _this.self());
        });
        this.process = p;
    };
    return Process;
...
var handleTell = function (p) { return function (m) {
    return p.system.getPlatform().tell(m.to, m.message);
}; };
