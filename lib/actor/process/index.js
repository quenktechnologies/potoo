...
var forward_1 = require("../system/op/forward");
...
var Process = /** @class */ (function () {
    ...
    Process.prototype.accept = function (e) {
        this
            ...
            .orJust(function () { return new discard_1.Discard(e.to, e.from, e.message); });
        return this;
    };
    ...
    Process.prototype.run = function () {
        this.handle =
            maybe_1.just(spawn(this))
                ...
                .map(handleExit(this));
        this.system.exec(new forward_1.Forward(this.self(), this.self()));
    };
    return Process;
}());
...
var handleMessages = function (p) { return function (c) {
    return c.on('message', function (m) { return match_1.match(m)
        ...
        .orElse(function (m) { return p.system.exec(new discard_1.Discard(p.self(), p.self(), m)); })
        .end(); });
}; };
...
var handleExit = function (p) { return function (c) {
    return c.on('exit', function () { return p.system.exec(new kill_1.Kill(p, p.self())); });
}; };
