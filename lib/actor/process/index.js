...
var Process = /** @class */ (function () {
    ...
    Process.prototype.init = function (c) {
        c.flags = c.flags | flags_1.FLAG_IMMUTABLE | (~flags_1.FLAG_BUFFERED) | flags_1.FLAG_ROUTER;
        return c;
    };
...
var handleRaise = function (p) { return function (_a) {
    ...
    return p.system.exec(p, new scripts_1.Raise("Error message from " + src + ": " + message));
}; };
