...
var Spawn = /** @class */ (function () {
    function Spawn(template) {
        ...
        this.immediate = true;
        this.info = [
            new info_1.NewForeignFunInfo('getTemp', 0, function (r) { return r.heap.addObject(new es_1.ESObject(r.heap, info_1.objectType, _this.template)); })
        ];
        this.code = [
            op.LDN | 0,
            op.CALL,
...
var Receive = /** @class */ (function () {
    function Receive(f) {
        ...
        this.name = 'receive';
        this.info = [
            new info_1.NewForeignFunInfo('receiver', 0, function (_, m) { return Number(_this.f(m)); })
        ];
        this.code = [
            op.LDN | 0,
            op.RECV
