...
var AbstractResident = /** @class */ (function () {
    ...
    AbstractResident.prototype.spawn = function (t) {
        return exports.spawn(this.system, this, t, this.self());
    };
...
var Immutable = /** @class */ (function (_super) {
    ...
    Immutable.prototype.init = function (c) {
        ...
        c.behaviour.push(function (_, m) {
            return Number(_this.receive.some(function (c) { return c.match(m); }));
        });
        return c;
    };
    /**
 ...
 */
exports.spawn = function (sys, i, t, parent) {
