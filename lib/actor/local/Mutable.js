...
var Mutable = /** @class */ (function (_super) {
        ...
        this.behaviour =
            this
                ...
                return Maybe_1.fromArray(_this.mailbox)
                    ...
                    .chain(function (m) { return b.apply(m); })
                    .map(function (b) { _this.consume(); return b; })
                    .orJust(function () { return b; });
            });
    };
    /**
    ...
    Mutable.prototype.select = function (cases) {
        ...
        this.behaviour =
            this
                .behaviour
                .map(function (b) { return match_1.match(b)
                .caseOf(_1.Select, function (b) { return b.merge(cases); })
                .orElse(function () { return b; }) //TODO: this should probably generate an error.
                .end(); })
                .orJust(function () { return new _1.Select(cases, _this.system); });
