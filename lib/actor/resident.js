...
var flag_1 = require("./system/op/flag");
...
var Immutable = /** @class */ (function (_super) {
     ...
     */
    Immutable.prototype.onRun = function () { };
    /**
     * select noop.
     */
    ...
    Immutable.prototype.run = function () {
        this.onRun();
        this.system.exec(new flag_1.Flag(this.self(), { immutable: true }));
        this.system.exec(new receive_1.Receive(this.self(), true, ibehaviour(this)));
    };
    return Immutable;
}(AbstractResident));
...
var Mutable = /** @class */ (function (_super) {
     ...
     * Use this instead of overriding the run hook.
     */
    Mutable.prototype.onRun = function () { };
    /**
    ...
    Mutable.prototype.run = function () {
        var _this = this;
        maybe_1.fromArray(this.receive)
            .map(function (r) { return _this.select(r); })
            .orJust(function_1.noop)
            .map(function () { return _this.onRun(); });
    };
    return Mutable;
}(AbstractResident));
