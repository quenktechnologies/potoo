...
var ActorSystem = /** @class */ (function () {
    function ActorSystem(stack, configuration) {
        ...
        this.state = { contexts: { $: nullFrame(this) }, routes: {} };
        this.running = false;
    }
    ...
    ActorSystem.prototype.allocate = function (t) {
        ...
        var stack = i[0] ? [i[0]] : [];
        return new context_1.ActorContext(flags.buffered ? maybe_1.just([]) : maybe_1.nothing(), a, stack, flags, t);
    };
...
var NullSystem = /** @class */ (function () {
    ...
    NullSystem.prototype.allocate = function (t) {
        return new context_1.ActorContext(maybe_1.nothing(), this, [], flagDefaults({}), t);
    };
...
var nullFrame = function (s) {
    return new context_1.ActorContext(maybe_1.nothing(), s, [], flagDefaults({}), new SysT());
};
