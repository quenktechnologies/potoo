 ...
 */
var IllegalKillSignalError = /** @class */ (function (_super) {
    __extends(IllegalKillSignalError, _super);
    function IllegalKillSignalError(child, parent) {
        var _this = _super.call(this, "The actor at address \"" + parent + "\" can not kill \"" + child + "\"!") || this;
        _this.child = child;
        _this.parent = parent;
        return _this;
    }
    return IllegalKillSignalError;
}(error_1.SystemError));
exports.IllegalKillSignalError = IllegalKillSignalError;
/**
 * Kill instruction.
 *
...
var execKill = function (s, _a) {
    ...
    return state_1.getAddress(s.state, actor)
        ...
        return s.exec(string_1.startsWith(child, addr) ?
            ...
            new raise_1.Raise(new IllegalKillSignalError(addr, child), addr, addr));
    })
