    ...
    StackFrame.prototype.resolve = function (data) {
        ...
        switch (typ) {
            case exports.DATA_TYPE_STRING:
                ...
                return mstr.isJust() ?
                    either_1.right(mstr.get()) :
                    either_1.left(new error.MissingSymbolErr(value));
            ...
            case exports.DATA_TYPE_HEAP:
                var mO = this.heap.get(value);
                if (mO.isNothing())
                    return either_1.left(new error.NullPointerErr(data));
                return either_1.right(mO.get().value);
            case exports.DATA_TYPE_HEAP_STRING:
                return either_1.right(this.heap.getString(value));
