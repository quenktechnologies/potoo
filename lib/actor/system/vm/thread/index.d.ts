...
export declare const THREAD_STATE_IDLE = 0;
export declare const THREAD_STATE_RUN = 1;
export declare const THREAD_STATE_WAIT = 2;
export declare const THREAD_STATE_CONTINUE = 3;
export declare const THREAD_STATE_ERROR = 4;
export declare const THREAD_STATE_INVALID = 5;
/**
 * ThreadState is a number corresponding to one of the THREAD_STATE_X constants.
 */
export declare type ThreadState = number;
/**
