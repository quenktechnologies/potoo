...
var LoggingLogic = (function () {
     ...
     * messageAccepted
     */
    LoggingLogic.prototype.messageAccepted = function (m) {
        if (this.policy.level >= exports.INFO)
     ...
     * messageRejected
     */
    LoggingLogic.prototype.messageRejected = function (m) {
        if (this.policy.level >= exports.WARN)
...
var System = (function () {
     ...
     */
    System.prototype.removeActor = function (actor, reason, asker) {
        var _this = this;
        this.actors = Object
            .keys(this.actors)
            .reduce(function (p, path) {
            if (path === actor) {
                _this.actors[actor].stop();
                _this.logging.actorRemoved(path, reason, asker);
            }
            else {
                p[path] = _this.actors[path];
            }
            return p;
        }, {});
    };
