...
var LoggingLogic = (function () {
     ...
     * actorRemoved
     */
    LoggingLogic.prototype.actorRemoved = function (path, reason) {
        if (reason !== 0) {
...
var System = (function () {
    ...
    System.prototype.removeActor = function (actor, reason) {
        var _this = this;
        this.actors = Object
            .keys(this.actors)
            .reduce(function (p, path) {
            if (_this.actors[path] === actor)
                _this.logging.actorRemoved(path, reason);
            else
