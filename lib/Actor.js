...
var Local = (function () {
     ...
     * @param {number} reason
     */
    Local.prototype.exit = function (reason) {
     ...
     */
    Local.prototype.kill = function (path) {
...
var Static = (function (_super) {
    ...
    Static.prototype.accept = function (m) {
        ...
        if (!r.some(function (c) { return c.match(m.value); }))
...
var Pending = (function () {
    ...
    Pending.prototype.stop = function () { };
    return Pending;
}());
 ...
 */
var FakeSystem = (function (_super) {
    __extends(FakeSystem, _super);
    function FakeSystem(s) {
        var _this = _super.call(this, s.config, s.actors, s.logging, s.path) || this;
        _this.s = s;
        return _this;
    }
    FakeSystem.prototype.putMessage = function (m) {
     ...
     */
    FakeSystem.prototype.askMessage = function (m) {
        this.logging.messageRejected(m);
     ...
     */
    FakeSystem.prototype.removeActor = function (_actor, _reason, asker) {
        console.warn("Will not remove actor for removed actor " + asker);
    };
    return FakeSystem;
}(System_1.System));
exports.FakeSystem = FakeSystem;
